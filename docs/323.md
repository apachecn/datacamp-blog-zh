...
> 原文:[https://web . archive . org/web/20221129045128/https://www . data camp . com/blog/what-we-know-GPT 4](https://web.archive.org/web/20221129045128/https://www.datacamp.com/blog/what-we-know-gpt4)
...
在 GPT-1 之前，大多数自然语言处理(NLP)模型都是针对分类、翻译等特定任务进行训练的。他们都在使用监督学习。这种类型的学习伴随着两个问题:缺乏注释数据和无法概括任务。
