...
> 原文:[https://web . archive . org/web/20221129035725/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129035725/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
*“想象你建立了一个 YOLO 应用程序，从给定的图像中检测球员和足球。*
...
基于锚的算法在幕后进行聚类，这增加了推理时间。在 YOLOX 中移除锚机制减少了每幅图像的预测数量，并显著改善了推理时间。
