...
> 原文:[https://web . archive . org/web/20221129044127/https://www . data camp . com/blog/what-we-know-GPT 4](https://web.archive.org/web/20221129044127/https://www.datacamp.com/blog/what-we-know-gpt4)
...
GPT-1 (117M 参数)论文([通过生成性预训练提高语言理解](https://web.archive.org/web/20221124153834/https://paperswithcode.com/paper/improving-language-understanding-by))发表于 2018 年。它提出了一种生成性语言模型，该模型在未标记的数据上进行训练，并在特定的下游任务(如分类和情感分析)上进行微调。
...
在问答环节，奥尔特曼说，GPT-4 不会像 DALL-E 那样是多模式的，它将是一个纯文本模式。
