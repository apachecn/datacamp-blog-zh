...
> 原文:[https://web . archive . org/web/20221129034451/https://www . data camp . com/blog/what-we-know-GPT 4](https://web.archive.org/web/20221129034451/https://www.datacamp.com/blog/what-we-know-gpt4)
...
在 AC10 在线会议的问答环节中，OpenAI 的首席执行官山姆·阿尔特曼证实了关于 GPT-4 模型发布的谣言。在本节中，我们将利用这些信息，并将其与当前趋势相结合，来预测模型大小、最佳参数和计算、多模态性、稀疏性和性能。
...
GPT 4 队将比 GPT 3 队更加团结。OpenAI 正在努力与人工智能保持一致。他们希望语言模型遵循我们的意图并坚持我们的价值观。
