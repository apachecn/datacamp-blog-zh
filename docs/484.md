...
> 原文:[https://web . archive . org/web/20221129033105/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129033105/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
该方法在每个特征金字塔网络(FPN)的特征图中引入一个隐式表示，提高了约 0.5%的精度。
