...
> 原文:[https://web . archive . org/web/20221129051850/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129051850/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
YOLOv1 不像 YOLOv2 那样预测对象边界框的精确坐标，而是通过用锚框替换完全连接的层来简化问题。这种方法虽然稍微降低了准确率，但是提高了 7%的模型召回率，这给了我们更多的改进空间。
