...
> 原文:[https://web . archive . org/web/20221129040116/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129040116/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
*   它很难在一组图像中检测到较小的图像，例如体育场中的一组人。这是因为 YOLO 架构中的每个网格都是为单个对象检测而设计的。
