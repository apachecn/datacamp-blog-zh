...
> 原文:[https://web . archive . org/web/20221129045040/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129045040/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
作者没有使用并集交集(IoU)方法，而是引入了 SimOTA，这是一种更健壮的标签分配策略，通过减少训练时间和避免额外的超参数问题来获得最先进的结果。此外，它还将检测 mAP 提高了 3%。
