...
> 原文:[https://web . archive . org/web/20221129045128/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129045128/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
YOLOv7 于 2022 年 7 月在论文[中发布，训练有素的免费赠品为实时物体探测器](https://web.archive.org/web/20221129052005/https://arxiv.org/pdf/2207.02696.pdf)设置了新的最先进的技术。该版本在目标检测领域迈出了重要的一步，在准确性和速度方面超过了所有以前的型号。
