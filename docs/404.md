...
> 原文:[https://web . archive . org/web/20221129054701/https://www . data camp . com/blog/yolo-object-detection-explained](https://web.archive.org/web/20221129054701/https://www.datacamp.com/blog/yolo-object-detection-explained)
...
作者通过使用单个卷积神经网络(CNN)在空间上分离包围盒并将概率与每个检测到的图像相关联，将对象检测问题框架为回归问题，而不是分类任务。
...
如果您对 Pytorch 更感兴趣，[使用 Pytorch 进行深度学习](https://web.archive.org/web/20221129052005/https://datacamp.com/courses/deep-learning-with-pytorch)将教您回旋神经网络以及如何使用它们来构建更强大的模型。
