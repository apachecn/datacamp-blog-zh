...
> 原文:[https://web . archive . org/web/20221212135909/https://www . data camp . com/blog/what-we-know-GPT 4](https://web.archive.org/web/20221212135909/https://www.datacamp.com/blog/what-we-know-gpt4)
...
创成式预培训变压器(GPT)是一个文本生成深度学习模式，培训的数据可在互联网上。它用于问答、文本摘要、机器翻译、分类、代码生成和会话人工智能。
